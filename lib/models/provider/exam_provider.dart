...
class ExamProvider with ChangeNotifier {
  ...
  ExamData? get currentExam => 
      _currentExamId != null ? _exams.firstWhere((e) => e.id == _currentExamId) : null;
  
  int get currentQuestionIndex => _currentQuestionIndex;
  
  Question? get currentQuestion => 
      currentExam != null && _currentQuestionIndex < currentExam!.questions.length
  ...
  bool get isLastQuestion => 
      currentExam != null && _currentQuestionIndex == currentExam!.questions.length - 1;
  ...
  Map<String, dynamic> calculateResults() {
    ...
    final double percentage = currentExam!.questions.isEmpty 
        ? 0 
